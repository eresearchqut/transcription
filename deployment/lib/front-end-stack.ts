...
export class FrontEndStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props: FrontendStackProps) {
    ...
    const distributionHostedZone = route53.HostedZone.fromLookup(
      this,
      "distribution-hosted-zone",
      {
    ...
    new route53.ARecord(this, "distribution-alias-record", {
      recordName:
        parameters.FrontEndAliasRecordName ?? parameters.FrontEndDomainName,
