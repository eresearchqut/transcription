...
const data = {
    NEXT_PUBLIC_AUTH_IDENTITY_POOL_ID: process.env.NEXT_PUBLIC_AUTH_IDENTITY_POOL_ID,
    NEXT_PUBLIC_AWS_REGION: process.env.NEXT_PUBLIC_AWS_REGION,
    NEXT_PUBLIC_AUTH_USER_POOL_ID: process.env.NEXT_PUBLIC_AUTH_USER_POOL_ID,
    NEXT_PUBLIC_AUTH_USER_POOL_CLIENT_ID: process.env.NEXT_PUBLIC_AUTH_USER_POOL_CLIENT_ID,
    NEXT_PUBLIC_AUTH_DOMAIN: process.env.NEXT_PUBLIC_AUTH_DOMAIN,
    NEXT_PUBLIC_AUTH_SIGN_IN_REDIRECT: process.env.NEXT_PUBLIC_AUTH_SIGN_IN_REDIRECT,
    NEXT_PUBLIC_AUTH_SIGN_OUT_REDIRECT: process.env.NEXT_PUBLIC_AUTH_SIGN_OUT_REDIRECT,
    NEXT_PUBLIC_TRANSCRIPTION_BUCKET: process.env.NEXT_PUBLIC_TRANSCRIPTION_BUCKET,
}
console.log({data})
