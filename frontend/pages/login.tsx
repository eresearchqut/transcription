          ...
          <VStack gap={4} align={"stretch"}>
            ...
            <Box>
              ...
              <Text>
                ...
                . Summaries are intended to provide an overview of the
                transcript and should not replace review of the source
                transcription. They may omit context or nuance from the original
                content.
              </Text>
            </Box>
          </VStack>
